...
public class SetVariableActionTest extends AndroidTestCase {
	...
	public void testSetVariableWithNumericalFormula() {
		testSprite.getActionFactory().createSetVariableAction(testSprite, null, new Formula(SET_VARIABLE_VALUE), userVariable).act(1f);
	...
	public void testSetVariableWithInvalidUserVariable() {
		testSprite.getActionFactory().createSetVariableAction(testSprite, null, new Formula(SET_VARIABLE_VALUE), null).act(1f);
	...
	public void testSetVariableWithNumericalStringFormula() {
		String myString = "155";
		testSprite.getActionFactory().createSetVariableAction(testSprite, null, new Formula(myString), userVariable).act(1f);
	...
	public void testNullFormula() {
		testSprite.getActionFactory().createSetVariableAction(testSprite, null, null, userVariable).act(1f);
		assertEquals("String UserVariable not changed!", 0d, userVariable.getValue());
	}

	public void testNotANumberFormula() {
		testSprite.getActionFactory().createSetVariableAction(testSprite, null, new Formula(Double.NaN), userVariable).act
				(1f);
