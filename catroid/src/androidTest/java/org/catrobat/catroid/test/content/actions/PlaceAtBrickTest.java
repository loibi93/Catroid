...
public class PlaceAtBrickTest extends AndroidTestCase {
	...
	public void testNormalBehavior() {
		...
		sprite.getActionFactory().createPlaceAtAction(sprite, null, xPosition, yPosition).act(1.0f);
	...
	public void testNullSprite() {
		try {
			sprite.getActionFactory().createPlaceAtAction(null, null, xPosition, yPosition).act(1.0f);
	...
	public void testBoundaryPositions() {
		...
		sprite.getActionFactory().createPlaceAtAction(sprite, null, new Formula(Integer.MAX_VALUE),
		...
		sprite.getActionFactory().createPlaceAtAction(sprite, null, new Formula(Integer.MIN_VALUE),
	...
	public void testBrickWithStringFormula() {
		sprite.getActionFactory().createPlaceAtAction(sprite, null, new Formula(String.valueOf(X_POSITION_VALUE)),
		...
		sprite.getActionFactory().createPlaceAtAction(sprite, null, new Formula(NOT_NUMERICAL_STRING),
	...
	public void testNullFormula() {
		sprite.getActionFactory().createPlaceAtAction(sprite, null, null, null).act(1.0f);
		assertEquals("Incorrect sprite x position after PlaceAtBrick executed", 0f,
				sprite.look.getXInUserInterfaceDimensionUnit());
		assertEquals("Incorrect sprite y position after PlaceAtBrick executed", 0f,
				sprite.look.getYInUserInterfaceDimensionUnit());
	...
	public void testNotANumberFormula() {
		sprite.getActionFactory().createPlaceAtAction(sprite, null, new Formula(Double.NaN), new Formula(Double.NaN))
				.act(1.0f);
		assertEquals("Incorrect sprite x position after PlaceAtBrick executed", 0f,
				sprite.look.getXInUserInterfaceDimensionUnit());
		assertEquals("Incorrect sprite y position after PlaceAtBrick executed", 0f,
