...
public class WaitActionTest extends AndroidTestCase {
	...
	public void testWait() throws InterruptedException {
		...
		WaitAction action = (WaitAction) factory.createDelayAction(null, null, new Formula(waitOneSecond));
	...
	public void testPauseResume() throws InterruptedException {
		...
		WaitAction action = (WaitAction) factory.createDelayAction(testSprite, null, new Formula(waitOneSecond));
	...
	public void testBrickWithStringFormula() {
		ActionFactory factory = new ActionFactory();
		WaitAction action = (WaitAction) factory.createDelayAction(null, null, new Formula(String.valueOf(VALUE)));
		long currentTimeInMilliSeconds = System.currentTimeMillis();
		do {
			currentTimeInMilliSeconds = System.currentTimeMillis() - currentTimeInMilliSeconds;
		} while (!action.act(currentTimeInMilliSeconds / 1000f));
		...
		action = (WaitAction) factory.createDelayAction(null, null, new Formula(NOT_NUMERICAL_STRING));
	...
	public void testNullFormula() {
		ActionFactory factory = new ActionFactory();
		WaitAction action = (WaitAction) factory.createDelayAction(null, null, null);
		long currentTimeInMilliSeconds = System.currentTimeMillis();
		do {
			currentTimeInMilliSeconds = System.currentTimeMillis() - currentTimeInMilliSeconds;
		} while (!action.act(currentTimeInMilliSeconds / 1000f));
	...
	public void testNotANumberFormula() {
		ActionFactory factory = new ActionFactory();
		WaitAction action = (WaitAction) factory.createDelayAction(null, null, new Formula(Double.NaN));
		long currentTimeInMilliSeconds = System.currentTimeMillis();
		do {
			currentTimeInMilliSeconds = System.currentTimeMillis() - currentTimeInMilliSeconds;
		} while (!action.act(currentTimeInMilliSeconds / 1000f));
