...
public class NfcDataHistory extends MediaHistory {
	...
	private static NfcDataHistory INSTANCE_BACKPACK;
	...
	public static NfcDataHistory getBackPackHistory() {
		if (INSTANCE_BACKPACK == null) {
			INSTANCE_BACKPACK = new NfcDataHistory();
		}
	...
	public static boolean getAllUndoRedoStatus() {
		...
		for (NfcDataHistory history : INSTANCE.values()) {
