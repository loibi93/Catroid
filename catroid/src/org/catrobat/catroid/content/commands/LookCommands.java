...
public class LookCommands {
	...
	* This one is simple, just save the old and new Name, and the look itself
	...
	/*
	* Here we need the List of lookDatas that are new
	* When executing, we add all, when undoing remove all
	* We also save a map with bricks, that reference looks that we
	* want to update. When we add the bricks, we update the bricks
	* again.
	 */
	...
	//When editing a look with Paintroid, we need to load the new or old File
