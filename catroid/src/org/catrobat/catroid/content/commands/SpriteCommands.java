...
public class SpriteCommands {
	...
	public static class AddSpriteCommand implements MediaCommand {
		...
		private Sprite backgroundSpriteBackup;
		...
		public void execute() {
			for (Sprite sprite : sprites) {
				if (sprite.isBackgroundSprite) {
					backgroundSpriteBackup = ProjectManager.getInstance().getCurrentProject().getSpriteList().get(0);
					ProjectManager.getInstance().getCurrentProject().replaceBackgroundSprite(sprite);
				} else {
		...
		public void undo() {
			...
			for (Sprite sprite : sprites) {
				if (sprite.isBackgroundSprite) {
					ProjectManager.getInstance().getCurrentProject().replaceBackgroundSprite(backgroundSpriteBackup);
				} else {
